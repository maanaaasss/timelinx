...
engine.dispatch({
  ...
  operations: [{
    ...
    clipId,
    transform: { ...currentTransform, positionX: { ...currentTransform.positionX, value: numValue } },
  }],
});
...
function getHandleAtPoint(sx: number, sy: number, obj: SceneObject, viewport: Viewport): HandleType | null

// Hit test: which object is at this screen point? (z-order priority)
function getObjectAtPoint(sx: number, sy: number, objects: SceneObject[], viewport: Viewport): string | null
```
