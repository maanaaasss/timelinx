...
/**
 * Creates an engine pre-loaded with demo content for testing.
 * This is the original sample data that was previously the default.
 * Use this for development/testing — real users get a blank editor.
 */
