...
<Callout type="warn" title="Always import structure after your preset">
  `structure.css` references the token variables. If you swap the import order, the component CSS
  can't resolve the variables.
</Callout>
...
:root {
  /* Video track  - blue */
  --track-video: #3b82f6;
  --track-video-dim: rgba(59, 130, 246, 0.7);
  --track-video-bg: rgba(59, 130, 246, 0.12);
  --track-video-border: rgba(59, 130, 246, 0.3);

  /* Audio track  - lighter blue */
  --track-audio: #60a5fa;
  --track-audio-bg: rgba(96, 165, 250, 0.12);
  --track-audio-border: rgba(96, 165, 250, 0.3);
