...
import { CompositorPreview, TimelineProvider as UITimelineProvider, MediaAssetsProvider } from '@timelinx/ui';
...
export function CompositorPreviewExample() {
