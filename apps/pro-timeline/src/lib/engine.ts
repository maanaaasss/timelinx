...
export function getEngine(): TimelineEngine {
  ...
  const timeline = createTimeline({
    ...
    tracks: [v1Track, v2Track, v3Track, a1Track, a2Track, a3Track, s1Track],
  });
...
export function addAssetToTimeline(drop: AddAssetDrop): void {
  ...
  const clipDuration = Math.min(maxClipDuration, 150);
